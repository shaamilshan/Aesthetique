    ...
    <section className="container mx-auto px-4 py-12" id={id}>
      <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
        ...
        <div data-aos="fade-right" className="lg:w-1/2 text-left">
          ...
          {/* Expanded Content (always visible in mobile) */}
          <p className="text-gray-600 mt-2 text-sm sm:text-base">
            that empower you to look and feel your best. Our carefully curated collection is designed. Elevate your beauty. Redefine elegance. Experience Aesthetique.
          </p>

          {/* Read More Button (hidden on mobile) */}
          <button
            className="mt-4 px-5 py-2 text-sm font-medium text-[#A53030] border border-[#A53030] rounded-lg transition hover:bg-[#A53030] hover:text-white hidden lg:block"
